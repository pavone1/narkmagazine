<?php
/**
 * @version		$Id: error.php 17282 2011-09-15 15:24:49Z nark $
 * @package		Joomla.Site
	...
	<div id="all">
		...
		<div id="header">
					...
					<div class="logoheader">
						...
						<ul class="skiplinks">
							<li><a href="#wrapper2" class="u2"><?php echo JText::_('TPL_NARK_SKIP_TO_ERROR_CONTENT'); ?></a></li>
							<li><a href="#nav" class="u2"><?php echo JText::_('TPL_NARK_ERROR_JUMP_TO_NAV'); ?></a></li>
		...
		<div id="contentarea2" >
				...
				<h2 class="unseen"><?php echo JText::_('TPL_NARK_NAVIGATION'); ?></h2>
